    ...
    return(
        ...
        <div class="container-fluid py-5">
            <div class="container py-5 px-lg-5">
                ...
                <p className="mb-4">Welcome to <b>NovaCodeZ</b>, where innovation meets experience to redefine digital excellence. As a pioneering force in the industry, we have proudly held the position as the #1 digital solution provider for over 3+ years.</p>
